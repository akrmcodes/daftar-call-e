...
class ConfirmHandleStore:
    ...
    def get_retry_run_id(self, batch_id: str, contact_id: str) -> str | None:
        raise NotImplementedError

    def put_retry_run_id(self, batch_id: str, contact_id: str, run_id: str) -> None:
        raise NotImplementedError
...
class InMemoryConfirmHandleStore(ConfirmHandleStore):
    ...
    def get_retry_run_id(self, batch_id: str, contact_id: str) -> str | None:
        with self._lock:
            return self._retry_run_ids.get((batch_id, contact_id))

    def put_retry_run_id(self, batch_id: str, contact_id: str, run_id: str) -> None:
        with self._lock:
            self._retry_run_ids[(batch_id, contact_id)] = run_id
